...
export class JobExpandComponent implements OnInit {
  ...
  tasks = [
    { title: 'TTM Road Set-Up', description: 'The Shoulder area of the road will be closed using cones & taper, King Edward Street, Remove FC signage from Rankeilor Street.' },
    { title: 'TTM Footpath Set-Up', description: 'Footpath Closed. This is the preferred risk assessment option for foot traffic based on keeping pedestrians away from walking past the work activity.' }
  ];
